  ...
  return (
    <div className={styles.find}>
      <div className={styles.heading}>
        <h1  class="font-extrabold text-transparent text-8xl bg-clip-text bg-gradient-to-r from-sky-400 to-pink-600">Find your drive</h1>
        <div className={styles.text_bg}>
          <p>
            <span className='text-sky-800'>Explore the world's largest car sharing marketplace</span>
          </p>
        </div>
      </div>
